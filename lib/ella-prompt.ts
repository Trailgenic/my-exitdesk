...
export default ELLA_SYSTEM_PROMPT;Create a new file at lib/ella-prompt.ts with exactly the following content. Do not modify any text inside the template literal:
