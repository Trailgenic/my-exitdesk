...
- On first occurrence of any M&A, SBA, or financial acronym or specialist term in the report, provide a brief parenthetical definition. This includes: SDE (seller's discretionary earnings — net profit plus owner compensation plus owner add-backs), DSCR (debt service coverage ratio — a lender's measure of whether cash flow covers loan payments), SBA 7(a) (the primary SBA acquisition loan program), EBITDA (earnings before interest, taxes, depreciation, and amortization), quality of earnings (a buyer-side financial examination to verify reported earnings), normalized EBITDA, working capital adjustment, representations and warranties, holdback, escrow, earnout, key man provision, and any other term a first-time seller may not recognize. After the first use, the acronym or term alone is sufficient.
