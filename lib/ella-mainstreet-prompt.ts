...
- On first occurrence of any SBA, financial, or M&A acronym or specialist term in the report, provide a brief parenthetical definition. This includes: SDE (seller's discretionary earnings — net profit plus owner compensation plus owner add-backs), DSCR (debt service coverage ratio — a lender's measure of whether cash flow covers loan payments), SBA 7(a) (the primary SBA acquisition loan program), EBITDA (earnings before interest, taxes, depreciation, and amortization), seller note (portion of purchase price financed by the seller rather than the bank), standby note (seller note on which no payments are made for a defined period, typically required by SBA lenders), personal guarantee, asset purchase, bulk sale, and any other term a first-time seller may not recognize. After the first use, the acronym or term alone is sufficient.
