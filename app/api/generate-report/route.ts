...
export async function POST(request: Request) {
  ...
  const intake: IntakePayload = {
    ...
    impliedRevenueRange: body.revenueRange || null,
    revenueModel: body.revenueModel || null,
    recurringPercent: body.recurringPercent || null,
    customerConcentration: body.customerConcentration || null,
    customerTenure: body.customerTenure || null,
    newBusinessSource: body.newBusinessSource || null,
    stepAwayBreaks: body.steppedAway || null,
    managementDepth: body.managementTeam || null,
    documentedSystems: body.documentedSystems || null,
    employeeCount: body.employeeCount || null,
    brandTiedToFounder: null,
    ebitdaRange: body.ebitdaRange || null,
    marginTrajectory: body.marginTrajectory || null,
    financialClean: body.financialClean || null,
    leaseAndFacilities: body.facility ?? null,
    hardToReplicate: body.hardToReplicate.join(", "),
    legalExposure: body.diligenceDisclosure || null,
    industryDynamics: body.industryDynamics || null,
    inboundInterest: body.inboundInterest || null,
    keyEmployeeRisk: body.keyEmployeeRisk || null,
