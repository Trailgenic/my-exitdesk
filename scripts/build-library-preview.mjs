...
const header = read("header.html").replaceAll('href="/m-and-a"', 'href="#main-content"').replaceAll('href="/m-and-a#available-resources"', 'href="#available-resources"').replaceAll('href="/rebuild-foundation#products"', 'href="https://www.mikeye.com/exit"');
let html = read("library-shell.html")
  ...
  .replace("</main></div>", `${fullDraftGuides()}</main>${read("footer.html")}</div>`);
